...
// import image from "../public/images/pizza_PNG7104.png";
  ...
  return (
    <div className=" fixed md:static w-full z-[10000] top-0  right-0 md:mt-3">
      <div className=" my-container  text-white flex  items-center justify-between bg-slate-700 p-6  md:rounded-2xl  shadow-md relative">
        <div className="text-white text-lg md:text-2xl align-middle ">
          <div className="align-middle">Pizza-Ramin</div>
        </div>
  ...
  return (
    <div className="md:hidden">
      ...
      >
        ...
        {/* <div className="w-32 h-24 relative  mt-24 mx-auto">
          <Image src={image} alt="Ramin" layout="fill" className="object-contain " />
          <div className="text-center text-orange-300 mt-[100px] text-lg font-semibold ">
            Pizza_Ramin
          </div>
        </div> */}
      </nav>

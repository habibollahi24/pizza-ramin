  ...
  return (
    <div className="  bg-slate-700  rounded-2xl shadow overflow-hidden relative">
      ...
      <div className=" text-gray-300 p-4 ">
        <div className="font-semibold text-2xl mt-2 p-2 text-red-200">{name}</div>
        <div className="text-sm text-red-100 leading-relaxed p-2 mb-6">{description}.</div>
        <div className="flex justify-between items-center p-1">
          ...
          <div className="font-semibold">
            {is_sale ? (
              <div>
                <div className="line-through">{priceFormat(price)} تومان</div>

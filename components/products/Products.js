...
const Products = ({ productsCategory, productTab }) => {
  ...
  return (
    <div className="">
      ...
      <ProductsTab productTab={productTab} setCurrentTab={setCurrentTab} currentTab={currentTab} />
...
const ProductsTab = ({ productTab, currentTab, setCurrentTab }) => {
  return (
    <div className="my-container ">
      <div>
        <ul className=" flex flex-col md:flex-row justify-center md:max-w-screen-sm md:mx-auto gap-3 my-10">
